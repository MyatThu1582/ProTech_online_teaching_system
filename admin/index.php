    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          <div class="card-body">
            <?php
            $user_datasstmt = $pdo->prepare("SELECT * FROM users ORDER BY id DESC");
              ...
              <tbody>
                ...
                foreach ($user_datas as $user_data) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="editUser.php?id=<?php echo $user_data['id']; ?>" type="button" class="btn btn-warning text-light btn-sm">
